...
#define WIC_PASSWORDHASH_MAX_LENGTH	61
...
enum ProductId
{
	PRODUCT_ID_WIC07_STANDARD_KEY = 0x1,
	PRODUCT_ID_WIC07_TIMELIMITED_KEY = 0x2,
	PRODUCT_ID_WIC08_STANDARD_KEY = 0x3,
	PRODUCT_ID_WIC08_TIMELIMITED_KEY = 0x4,
};
