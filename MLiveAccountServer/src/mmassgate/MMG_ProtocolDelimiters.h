...
namespace MMG_ProtocolDelimiters
{
	enum Delimiter : short
	{
		...
		SERVERTRACKER_SERVER_AUTH_DS_CONNECTION,			// MMG_TrackableServer::PrivHandleStartUp
		SERVERTRACKER_SERVER_QUIZ_FROM_MASSGATE,
		SERVERTRACKER_SERVER_QUIZ_ANSWERS_TO_MASSGATE,		// MMG_TrackableServer::PrivDoMassgateQuiz
		...
		SERVERTRACKER_SERVER_STARTED,						// MMG_TrackableServer::PrivHandleStartUp
		SERVERTRACKER_SERVER_STOPED,
		SERVERTRACKER_SERVER_STATUS,						// MMG_TrackableServer::ReportServerVars
		SERVERTRACKER_SERVER_GAME_FINISHED,
		SERVERTRACKER_SERVER_ACK,
		SERVERTRACKER_SERVER_MAP_LIST,						// MMG_TrackableServer::Update
		...
		SERVERTRACKER_SERVER_LOG_CHAT,						// MMG_TrackableServer::Update
