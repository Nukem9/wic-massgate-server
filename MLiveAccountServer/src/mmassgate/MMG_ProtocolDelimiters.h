...
namespace MMG_ProtocolDelimiters
{
	enum Delimiter : short
	{
		...
		MESSAGING_DS_PING,									// W MMG_TrackableServer::ReportServerVars
		MESSAGING_DS_PONG,									// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_INVITE_RESERVE_SPOT_FOR_PROFILE,		// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_INVITE_RESULT,							// W MMG_TrackableServer::HandleDSInviteProfileToServer
		MESSAGING_DS_REQ_GET_PCC,							// ?
		MESSAGING_DS_RSP_GET_PCC,							// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_SET_METRICS,							// W MMG_TrackableServer::UpdateClientMetrics
		MESSAGING_DS_FINAL_INIT_FOR_MATCH_SERVER,			// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_FINAL_ACK_FROM_MATCH_SERVER,			// ?
		MESSAGING_DS_INFORM_PLAYER_JOINED,					// W MMG_TrackableServer::InformPlayerConnected
		MESSAGING_DS_KICK_PLAYER,							// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_GET_QUEUE_SPOT_REQ,					// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_GET_QUEUE_SPOT_RSP,					// W MMG_WaitForSlotProtocol::DSToMassgateGetDSQueueSpotRsp::ToStream
		MESSAGING_DS_REMOVE_QUEUE_SPOT_REQ,					// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_GET_BANNED_WORDS_REQ,					// W MMG_BannedWordsProtocol::GetReq::ToStream
		MESSAGING_DS_GET_BANNED_WORDS_RSP,					// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_REMOVE_MAP_REQ,						// R MMG_TrackableServer::HandleMessage
		MESSAGING_DS_SECTION_END,							//
		MESSAGING_DS_END,									//

		SERVERTRACKER_USER_START,							//
		SERVERTRACKER_USER_MINIPINGREQUEST,					// W MMG_ServerTracker::PrivHandlePingers
		SERVERTRACKER_USER_MINIPINGRESPONSE,				// W MMG_TrackableServer::ThreadedPingHandler::handleClientRequests
		...
		SERVERTRACKER_USER_GAME_EXTENDED_INFO_REQUEST,		// W MMG_ServerTracker::PrivHandlePingers
		SERVERTRACKER_USER_GAME_EXTENDED_INFO_RESPONSE,		// W MMG_TrackableServer::ThreadedPingHandler::handleClientRequests
		...
		SERVERTRACKER_USER_CYCLE_MAP_LIST_REQ,				// W MMG_ServerTracker::PrivRequestCycleHash
		...
		SERVERTRACKER_SERVER_AUTH_DS_CONNECTION,			// W MMG_TrackableServer::PrivHandleStartUp
		SERVERTRACKER_SERVER_QUIZ_FROM_MASSGATE,			// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_QUIZ_ANSWERS_TO_MASSGATE,		// W MMG_TrackableServer::PrivDoMassgateQuiz
		SERVERTRACKER_SERVER_QUIZ_FAILED,					// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_PUBLIC_ID,						// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_INTERNAL_AUTHTOKEN,			// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_REPORT_PLAYER_STATS,			// W MMG_TrackableServer::ReportPlayerStats
		SERVERTRACKER_SERVER_STARTED,						// W MMG_TrackableServer::PrivHandleStartUp
		SERVERTRACKER_SERVER_STOPED,						// W MMG_TrackableServer::ServerStopped
		SERVERTRACKER_SERVER_STATUS,						// W MMG_TrackableServer::ReportServerVars
		SERVERTRACKER_SERVER_GAME_FINISHED,					// W MMG_TrackableServer::GameStopped
		SERVERTRACKER_SERVER_ACK,							// R MMG_TrackableServer::Update
		SERVERTRACKER_SERVER_MAP_LIST,						// R MMG_TrackableServer::Update/MMG_TrackableServer::PrivHandleRemoveMapReq
		SERVERTRACKER_SERVER_REPORT_CLAN_STATS,				// W MMG_TrackableServer::ReportClanStats
		SERVERTRACKER_SERVER_CLAN_MATCH_PRELOAD,			// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_CLAN_MATCH_INFO,				// ?
		SERVERTRACKER_SERVER_TOURNAMENT_INFO,				// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_TOURNAMENT_RESET,				// ?
		SERVERTRACKER_SERVER_TOURNAMENT_PENDING,			// R MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_TOURNAMENT_LOAD_MAP_COMPLETE,	// W MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_TOURNAMENT_LOAD_MAP_FAILED,	// W MMG_TrackableServer::HandleMessage
		SERVERTRACKER_SERVER_TOURNAMENT_REPORT_STATS,		// ?
		SERVERTRACKER_SERVER_LOG_CHAT,						// W MMG_TrackableServer::Update
		SERVERTRACKER_SERVER_CHANGE_RANKING_REQ,			// W MMG_DSChangeServerRanking::ChangeRankingReq::ToStream
		SERVERTRACKER_SERVER_CHANGE_RANKING_RSP,			// R MMG_TrackableServer::Update
		SERVERTRACKER_SERVER_END,							//

		CHAT_START,											//
		CHAT_DENIED,										// ?
		CHAT_DENIED_ROOM_FULL,								// R MMG_Chat::HandleMessage
		CHAT_DENIED_ROOM_PASSWORD_WRONG,					// R MMG_Chat::HandleMessage
		CHAT_DENIED_COULD_NOT_JOIN_ROOM,					// R MMG_Chat::HandleMessage
		CHAT_REAL_JOIN_REQ,									// W MMG_Chat::JoinRoom
		CHAT_REAL_JOIN_RSP,									// R MMG_Chat::HandleMessage
		CHAT_LEAVE_ROOM_REQ,								// W MMG_Chat::LeaveRoom
		CHAT_SEND_MESSAGE_REQ,								// W MMG_Chat::SendChat
		CHAT_LIST_ROOMS_REQ,								// W MMG_Chat::GetRoomListing
		CHAT_ROOM_INFO_RSP,									// R MMG_Chat::HandleMessage
		CHAT_NO_MORE_ROOMS_IN_LIST,							// R MMG_Chat::HandleMessage
		CHAT_USER_CHAT_MESSAGE,								// R MMG_Chat::HandleMessage
		CHAT_USER_LEFT,										// R MMG_Chat::HandleMessage
		CHAT_USER_IN_ROOM,									// R MMG_Chat::HandleMessage
		CHAT_END,											//
	...
	enum DelimiterType : int
	{
		DELIM_UNKNOWN,
		DELIM_ACCOUNT,
		DELIM_MESSAGE,
		DELIM_SERVERTRACKER_USER,
		DELIM_SERVERTRACKER_SERVER,
		DELIM_CHAT,
		DELIM_NATNEG,
	};
